# gordondondon
gordondondon is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
You can gordondondon Project via npm:

```bash
npm install gordondondon
```
## Usage

const Web3Tools = require('gordondondon');
